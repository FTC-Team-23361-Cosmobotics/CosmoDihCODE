...
public class BlueGoalAuto extends OpMode {
    ...
    /** SPIKE COORDINATES **/
    private final double spikeX = 19, highSpikeY = 84, midSpikeY = 60, lowSpikeY = 36;
    private final double startHeading = Math.toRadians(-45);

    /** START AND SCORE POSES **/
    private final Pose startPose = new Pose(22, 121); // Start Pose of our robot.
    private final Pose scorePose = new Pose(42, 102); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
