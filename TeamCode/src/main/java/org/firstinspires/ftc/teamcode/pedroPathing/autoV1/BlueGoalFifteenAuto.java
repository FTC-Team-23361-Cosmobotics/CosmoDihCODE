...
@Autonomous(name = "BlueGoalAuto: Fifteen Artifacts", group = "GoalAuto", preselectTeleOp = "BlueDihCodeTeleop")
public class BlueGoalFifteenAuto extends OpMode {
    ...
    /** POSE COORDINATES **/
    public static double hpX = 141.4-136, hpY = 12, hpHeading = Math.toRadians(90);
    public static double startX = 141.4-126.20757825370676, startY = 119.32784184514004, startHeading = Math.toRadians(180-36);
    public static double spikeX = 141.4-119, highSpikeY = 83, midSpikeY = 58, lowSpikeY = 34;
    public static double scoreX = 141.4-88, scoreY = 141.4-88, scoreMedX = 141.4-88, scoreMedY = 141.4-88, scoreHeading = Math.toRadians(180-45);

    public static double parkX = 141.4-90, parkY = 104, parkHeading = Math.toRadians(180-45);
    public static double gateX = 141.4-127, gateY = 66, gateHeading = Math.toRadians(90);
    ...
    private final Pose hpControlPose = new Pose(hpX+3, 74);
    ...
    public void buildPaths() {
        ...
        scorePPG = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(highSpikePose.getHeading(), scoreHeading, .4)
                .build();

        grabPGP = follower.pathBuilder()
                .addPath(new BezierCurve(scorePose, midSpikeControlPtPose, midSpikePose))
                .setLinearHeadingInterpolation(scoreHeading, midSpikePose.getHeading(), .5)
                .build();
        ...
        scorePGP = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(gateHeading, scoreHeading, .5)
                .build();
        ...
        grabHP = follower.pathBuilder()
                .addPath(new BezierCurve(scorePose, hpControlPose, hpPose))
                .setLinearHeadingInterpolation(scoreHeading, hpPose.getHeading(), .8)
                .build();

        scoreHP = follower.pathBuilder()
                .addPath(new BezierCurve(hpPose, hpControlPose, scorePose))
                .setLinearHeadingInterpolation(hpPose.getHeading(), scoreHeading, .8)
                .build();
